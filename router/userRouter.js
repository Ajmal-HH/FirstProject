...
user_router.get('/homepage',auth.isLogin,auth.is_blocked,userController.homepage)
...
user_router.get('/changepassword',auth.isLogin,profileController.loadChangePass)
...
user_router.get('/shop',auth.isLogin,auth.is_blocked,userController.loadShop)
user_router.get('/shopdetails',auth.isLogin,auth.is_blocked,userController.viewProductDetails)
...
user_router.get('/lowtohigh',auth.isLogin,userController.sortLowToHigh)
user_router.get('/hightolow',auth.isLogin,userController.sortHighToLow)
...
user_router.get('/wallet',auth.isLogin,orderController.wallet)
